...
<Tabs width="40%" className='mb-5 missiontab' defaultActiveKey="Research" id="uncontrolled-tab-example">
  ...
  <div id="Research" className="container OurMission my-5 py-5">
            <div className="row">
                ...
                <div className="col-md-6 mission-para">
                    <h5 className='h2-text'> 50 Years of Japan-Bangladesh relationship and opportunities for future collaboration
  ...
  <div id="Training" className="container OurMission my-5 py-5">
            <div className="row">
                ...
                <div className="col-md-6 mission-para">
                    <h5 className='h2-text'>Start your Entrepreneurship with Japan </h5>
  ...
  <div id="Consulting" className="container OurMission my-5 py-5">
            <div className="row">
                ...
                <div className="col-md-6 mission-para">
                    <h5 className='h2-text'>Consulting for Small Business Development</h5>
  ...
  <div id="Funding" className="container OurMission my-5 py-5">
            <div className="row">
                ...
                <div className="col-md-6 mission-para">
                    <h5 className='h2-text'>Fund Raising for Business and Social Development
</h5>
