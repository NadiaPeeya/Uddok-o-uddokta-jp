...
const TrainingBanner = () => {
    return (
        <div  id="carouselExampleCaptions" className="carousel slide trainingBanner" data-bs-ride="carousel">
...
<div className="carousel-inner">
 <div className="carousel-item trainingBannerimg active">
 ...
 <div className="carousel-item trainingBannerimg-2">
   {/*<img src="" className="d-block w-100" alt="..."/> */}
   <div className="carousel-caption d-none d-md-block">
   <div className="banner-text mx-auto">
             <div className="looped-text">
 ...
 <div className="carousel-item trainingBannerimg-3">
   {/*<img src="" className="d-block w-100" alt="..."/> */}
   <div className="carousel-caption d-none d-md-block">
   <div className="banner-text mx-auto">
             <div className="looped-text">
