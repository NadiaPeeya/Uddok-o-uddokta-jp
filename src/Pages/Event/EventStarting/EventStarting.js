...
<div>
        ...
        <div className="row container m-5">
               {/* <Grid xs={12} sm={12} md={4} className="session1  container">
         ...
         <Grid xs={12} sm={12} md={3} className="session1 p-3 container">
               <img width="80%" src="https://i.ibb.co/FYWYqSz/image-27-12-21-03-53.jpg" alt="" />
        
        </Grid>
               <Grid xs={12} sm={12} md={3} className="session1 p-3 container">
               <img width='80%' src="https://i.ibb.co/NnnxVQr/Logo-1.png" alt="" />
