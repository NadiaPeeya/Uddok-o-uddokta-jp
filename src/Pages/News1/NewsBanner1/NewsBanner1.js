...
import './NewsBanner1.css'

const NewsBanner1 = () => {
    return (
        <div  id="carouselExampleCaptions" className="carousel slide newsBanner1" data-bs-ride="carousel">
...
<div className="carousel-inner">
 <div className="carousel-item newsBanner1img active">
...
{/* 
 <div className="carousel-item newsBanner1img-2">
 ...
 {/* <div className="carousel-item newsBanner1img-3">
   <div className="carousel-caption d-none d-md-block">
   <div className="banner-text mx-auto">
             <div className="looped-text">
                 <div className="banner-title">
