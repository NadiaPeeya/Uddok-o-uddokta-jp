...
import './NewsBanner2.css'

const NewsBanner2 = () => {
    return (
        <div  id="carouselExampleCaptions" className="carousel slide newsBanner2" data-bs-ride="carousel">
...
<div className="carousel-inner">
 <div className="carousel-item newsBanner2img active">
...
{/* 
 <div className="carousel-item newsBanner2img-2">
 ...
 {/* <div className="carousel-item newsBanner2img-3">
   <div className="carousel-caption d-none d-md-block">
   <div className="banner-text mx-auto">
             <div className="looped-text">
                 <div className="banner-title">
